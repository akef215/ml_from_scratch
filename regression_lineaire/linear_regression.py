...
class linear_regression:
    ...
    def fit(self, X, Y, learning_rate=0.01, max_iter=1000, method='normal'):
        """
        ...
        """
        if method == 'normal':
            print("Normale Equation")
        elif method == 'gradient':
            self.coef_, self.bias_, self.history_ = self._gradient_descent(X, Y, learning_rate, max_iter)
        else:
